...
class AppColors {
  ...
  static const Color surfaceDark = Color(0xFF1E1E1E); // Slightly lighter
  static const Color cardDark = Color(0xFF2A2A2A); // Card surface
  
  static const Color textPrimaryDark = Color(0xFFE8E8E8); // Soft white
  static const Color textSecondaryDark = Color(0xFF9E9E9E); // Muted gray
  static const Color textTertiaryDark = Color(0xFF6E6E6E); // Subtle gray
  ...
  static const Color surfaceLight = Color(0xFFF8F8F8); // Soft gray
  static const Color cardLight = Color(0xFFF5F5F5); // Card surface
